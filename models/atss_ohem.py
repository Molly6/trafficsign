...
class ATSS_OHEM(M.Module):
    ...
    def forward(self, image, im_info, gt_boxes=None):
        ...
        if self.training:
            ...
            pred_score, clipped_boxes = self.inference(all_level_box_logits, all_level_box_offsets, all_level_box_ctrness, anchors_list, im_info)
